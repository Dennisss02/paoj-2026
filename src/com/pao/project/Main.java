...
public class Main {
    private static void meniu() {
        ...
        System.out.println("17. Top 5 al produselor vandute");
        System.out.println("18. Totalul incasarilor per restaurant");
            ...
            try {
                ...
                switch(optiune) {
                    ...
                    case 16:
                        ...
                        break;
                    case 17:
                        app.afiseazaTop5ProduseVandute();
                        break;
                    case 18:
                        app.afiseazaIncasariRestaurante();
                        break;
                    default:
